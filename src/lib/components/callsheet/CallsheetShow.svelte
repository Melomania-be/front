...
<div
	class="relative w-full py-6 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 rounded-lg px-4 sm:px-6 lg:px-8"
>
	{#if callsheet}
		<div class="flex flex-col gap-10">
			...
			<div class="relative">
				...
				>
					<div
						class="content-container bg-white dark:bg-gray-900 shadow-lg rounded-xl px-3 sm:px-4 md:px-6 py-4 sm:py-6 max-w-4xl mx-auto border border-white/20 backdrop-blur-sm"
					>
						<!-- Program Section -->
