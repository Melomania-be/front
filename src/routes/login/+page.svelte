...
<div class="min-h-screen flex items-center justify-center bg-gray-100 p-4">
	...
	>
		...
		{:else}
			<div class="p-8 text-center" in:scale={{ duration: 400, easing: elasticOut }}>
				<div
					class="rounded-full bg-green-100 p-3 mx-auto w-16 h-16 flex items-center justify-center mb-4"
				>
					<svg
