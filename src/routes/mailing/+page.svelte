...
>
	...
	<div class="col-span-1 p-2">
		<p class="mb-20">
			Here is where you can send mails to lists of contacts. You can either send a unique mail (it will not be saved) or use a template. <br/>
			To edit or create templates, please go to the <button
	...
	on:click={() => (useTemplate = true)}>Use a template</button
				>
	<div class="ml-10 pt-5 grid grid-cols-2 gap-10">
		<div
	...
	<div class="ml-10 pt-5 grid grid-cols-2 gap-10">
		...
		>
			...
			<p> Please select the template you want to use :
