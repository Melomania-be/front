<script lang="ts">
	...
	import RecruitmentAlertsModal from '$lib/components/RecruitmentAlertsModal.svelte';
    let showRecruitmentAlertsModal = false; 
...
<div>
		 <RecruitmentAlertsModal bind:showAlertDialog={showRecruitmentAlertsModal} />
	<div
