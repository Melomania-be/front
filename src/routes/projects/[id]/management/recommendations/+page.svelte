...
<div class="flex">
	<div class="w-1/2">
		<form class="w-[40rem] mx-auto p-4">
				...
				<div class="max-w-sm mx-auto">
					...
					<div class="flex">
						<input
							...
							id="lastName"
							class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
							bind:value={selectedData.lastName}
							placeholder="Green"
							required
						/>
					</div>
			...
			<div class="max-w-md mx-auto p-4">
				...
				<div class="flex">
					...
					<input
						...
						id="Messager"
						class="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
						bind:value={selectedData.messenger}
			...
			<div>
				<div
					class="w-[16mv] mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600"
				>
					<div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
						<label for="comment" class="sr-only">Your comment</label>
						<textarea
							bind:value={selectedData.comment}
							id="comment"
							rows="4"
		...
		<button
			on:click={addContactFromRecommended}
			type="button"
			class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
			>Create a new contact from the recommendation</button
		>
		<button
			on:click={deleteRecommended}
			type="button"
			class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
			>Delete the recommendation</button
		>
	</div>
	<div class="flex flex-col w-1/2">
		...
		{#if contact.id != null}
			<button
				on:click={() => sendParticipationValidationNotification(contact.id)}
				type="button"
				class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
				>Send a email of participation for the project</button
			>
		{/if}
