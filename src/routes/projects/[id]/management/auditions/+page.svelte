...
<script lang="ts">
	...
	function copyAuditionLink(audition: any) {
		...
		navigator.clipboard.writeText(auditionLink).then(() => {
			showNotification(`Audition link copied! You can now share it via WhatsApp or other channels.`, 'success');
				...
				<div class="bg-gray-50 border-2 border-gray-300 rounded-lg p-3 mb-4">
					<div class="flex items-center justify-between">
						<div class="flex-1 min-w-0">
							...
							<p class="text-sm font-mono text-gray-800 truncate" title="{getFrontendUrl()}/audition/{selectedAudition.secure_token}">
